...
namespace WebApiCoursesService.Controllers
{
    public class NtpuController : ApiController
    {
        ...
        public IQueryable<NtpuCourseModel> GetBySearchAll(string query, string query2 = null, string query3 = null, string exclude = null, int topn=-1)
        {
            ...
            result = CourseUtl.TopnFilter<NtpuCourseModel>(result.AsQueryable< NtpuCourseModel>(), topn);

            return result.AsQueryable<NtpuCourseModel>();
        }

        public IQueryable<NtpuCourseModel> GetBySearchEach(string coursename=null, string teachername = null, string department = null, string weekday = null,int topn=-1)
        {
